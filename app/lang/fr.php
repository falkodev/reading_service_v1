<?php 
 return array(  
   ...
   'subscribe_text_1' => "L'inscription nécessite 2 étapes.",
   ...
   'popover_content'  => 'Vous pourriez choisir comme premier jour le lendemain de la réunion de service. Ainsi, vous terminerez votre lecture de la Bible le jour de votre réunion de service.<br/><br/> Par exemple, si votre réunion est le mardi, en choisissant mercredi comme "premier" jour de la semaine (et en ayant aussi inclu mardi dans les jours où vous recevrez une portion), vous terminerez la lecture le mardi.',
   'daily_comment'  => 'Enfin, voulez-vous recevoir aussi le texte du jour quotidiennement ?',
   ...
   'faq_question_2_title' => 'Qui suis-je ?',
   ...
   'account_text_5' => 'Les jours que vous avez inscrit pour recevoir la lecture de la Bible',
