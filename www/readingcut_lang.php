...
/************* pour la version fr : bien enlever le "1" à la ligne 374 $xpath_recherche = recupJson($url_index, "1"); **********/
...

{
	...
	if($text == $versetNext){		
        ...
        //if($numeroVerset == 2) { echo "<br>Deut 23:2 => fin"; exit;}
...

{
...

    {
        ...
        //echo "<br>fct recupJson : passage en json = 1 /// lien = $lien /// pos = $pos<br>";
...

{
    ...
    //echo "verset = Deut $numeroChapitre:$numeroVerset";
...

	{
		...
		//var_dump($xpath_recherche); 

        /*foreach($xpath_recherche as $test) 

        {

            echo "<br>boucle xpath_recherche => $test";
...

		{
...

			{
				...
				{                           
					...
					//echo "json = $json /// lien final = $url_recherche /// verset = Deut $numeroChapitre:$numeroVerset<br> ";
