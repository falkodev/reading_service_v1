...
// $langPortionSentence = "Porțiunea din data este de la";
// $langPortionTo = "la";
// $langChapter = "Capitol";
...
$versets .= "<br><br>\r\n\r\n/////////// $langResearchesTitle ///////////<br><br>\r\n\r\n$ancres\r\n<br><br>";
$versets = "$langReadingSentence $liste_lecture.<br><br>\r\n\r\n".$versets;
...
for($i=2;$i<8;$i++) //boucle de 2 à 7 pour envoyer les portions nécessaires pour les différents découpages possibles
{
    ...
    for($k=0;$k<$countVerses;$k++)
    {
        ...
        if($k == ($comp - 1)) 
        {
            ...
            $versets = "$langReadingSentence $liste_lecture.<br><br>\r\n\r\n$langPortionSentence $premierVerset $langPortionTo $dernierVerset.<br><br>\r\n\r\n".$versets;
            $versets = mb_convert_encoding($versets, 'HTML-ENTITIES', "UTF-8");
			$versets = str_replace("+.",".",$versets);
			$versets = str_replace("*.",".",$versets);
			$versets = str_replace("+,",",",$versets);
